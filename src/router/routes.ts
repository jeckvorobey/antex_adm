  ...
  },
  {
    ...
    children: [
      ...
      { path: 'settings', name: 'settings', component: () => import('@pages/SettingsPage.vue') },
      {
        path: 'aex/rates',
        name: 'aex-rates',
        component: () => import('@pages/aex/AexRatesSettingsPage.vue'),
      },
      {
        path: 'aex/wallets',
        name: 'aex-wallets',
        component: () => import('@pages/aex/AexWalletsPage.vue'),
      },
      {
        path: 'aex/journal',
        name: 'aex-journal',
        component: () => import('@pages/aex/AexJournalPage.vue'),
      },
      {
        path: 'aex/manual-ops',
        name: 'aex-manual-ops',
        component: () => import('@pages/aex/AexManualOpsPage.vue'),
      },
    ],
  },
